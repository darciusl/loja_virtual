			...
			<div class="row">
				<div class="col-lg-12 well" style="margin-top:50px;padding-top:30px">
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<input id="textinput" name="codProduto" value="${pro.codProduto}"
								type="text" class="form-control input-md" readonly="readonly"> <br><br>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<label class="col-md-4 control-label" for="textinput">Gênero</label>
						<div class="col-md-8">
							<input id="textinput" name="genero" value="${pro.genero}"
								type="text" class="form-control input-md"> <br><br>
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-4 control-label" for="textinput">Plataforma</label>
						<div class="col-md-8">
							<input id="textinput" name="plataforma" value="${pro.plataforma}"
								type="text" class="form-control input-md"> <br><br>
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-4 control-label" for="textinput">Desenvolvedor</label>
						<div class="col-md-8">
							<input id="textinput" name="desenvolvedor" value="${pro.desenvolvedor}"
								type="text" class="form-control input-md"> <br><br>
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-4 control-label" for="textinput">Faixa Etária</label>
						<div class="col-md-8">
							<input id="textinput" name="faixaEtaria" value="${pro.faixaEtaria}"
								type="text" class="form-control input-md"> <br><br>
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-4 control-label" for="textinput">Peso em gramas</label>
						<div class="col-md-8">
							<input id="textinput" name="peso" value="${pro.peso}"
								type="text" class="form-control input-md"> <br><br>
						</div>
					</div>
					<div class="form-group">
