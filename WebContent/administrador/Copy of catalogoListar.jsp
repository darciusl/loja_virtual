...
<div class="well">
        <div class="container">
                <div class="row">
                        ...
                        <br><br>
                <h1 style="color: #000">Catalago de Produtos</h1>  
            <br>
                        ...
                        <tbody>
                           <%
                                ...
                                <tr>
                                    ...
                                    <td><%=x.getPreco()%></td>
                                    <td><a style="color: #000" href="<%=request.getContextPath()%>/administrador/CatalogoCRUD?cmd=editar&cod=<%=x.getCodProduto()%>">Editar</a></td>
                                    <td><a style="color: #000" href="<%=request.getContextPath()%>/administrador/CatalogoCRUD?cmd=deletar&cod=<%=x.getCodProduto()%>">Excluir</a></td>
